...
namespace zCode.zField
{
    ...
    internal class IDWField3dDouble : IDWField3d<double>
    {
        ...
        {
            /// <inheritdoc />
            public override IDWField3d<double> Create(double power, double epsilon = zMath.ZeroTolerance)
            {
        ...
        /// 
        /// </summary>
        public IDWField3dDouble(double power, double epsilon = zMath.ZeroTolerance)
            : base(power, epsilon)
        {
        }
