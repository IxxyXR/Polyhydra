...
namespace zCode.zField
{
    ...
    public static class IDiscreteFieldExtension
    {
        ...
        /// 
        /// </summary>
        public static bool ApproxEquals(this IDiscreteField<double> f0, IDiscreteField<double> f1, double tolerance = zMath.ZeroTolerance)
        {
        ...
        /// 
        /// </summary>
        public static bool ApproxEquals(this IDiscreteField<Vec2d> f0, IDiscreteField<Vec2d> f1, double tolerance = zMath.ZeroTolerance)
        {
            return ArrayMath.ApproxEquals(f0.Values, f1.Values, f0.Count, tolerance);
        }
        ...
        /// 
        /// </summary>
        public static bool ApproxEquals(this IDiscreteField<Vec3d> f0, IDiscreteField<Vec3d> f1, double tolerance = zMath.ZeroTolerance)
        {
            return ArrayMath.ApproxEquals(f0.Values, f1.Values, f0.Count, tolerance);
        }
