...
namespace zCode.zField
{
    ...
    public static class PerlinNoise
    {
        ...
        public static double ValueAt(double x, double y)
        {
            ...
            x = zMath.Fract(x, out int i);
            y = zMath.Fract(y, out int j);
            ...
            return zMath.Lerp(
              zMath.Lerp(n00, n10, x),
              zMath.Lerp(n01, n11, x),
              y);
        }
        ...
        public static double ValueAt(double x, double y, double z)
        {
            ...
            return zMath.Lerp(
              zMath.Lerp(
              zMath.Lerp(n000, n100, x),
              zMath.Lerp(n010, n110, x),
              y),
              zMath.Lerp(
              zMath.Lerp(n001, n101, x),
              zMath.Lerp(n011, n111, x),
              y),
              z);
        }
