...
namespace zCode.zMesh
{
        ...
        where TE : HeGraph<TV, TE>.Halfedge
    {
        ...
        /// <returns></returns>
        public TG CreateFromLineSegments(IEnumerable<Vec3d> points, Action<TV, Vec3d> setPosition, double tolerance = zMath.ZeroTolerance, bool allowMultiEdges = false, bool allowLoops = false)
        {
