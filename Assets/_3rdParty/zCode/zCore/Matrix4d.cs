...
namespace zCode.zCore
{
    ...
    public partial struct Matrix4d
    {
        ...
        */
        ...
        /// <returns></returns>
        public bool ApproxEquals(ref Matrix4d other, double tolerance = zMath.ZeroTolerance)
        {
            return
                zMath.ApproxEquals(M00, other.M00, tolerance) &&
                zMath.ApproxEquals(M01, other.M01, tolerance) &&
                zMath.ApproxEquals(M02, other.M02, tolerance) &&
                zMath.ApproxEquals(M03, other.M03, tolerance) &&

                zMath.ApproxEquals(M10, other.M10, tolerance) &&
                zMath.ApproxEquals(M11, other.M11, tolerance) &&
                zMath.ApproxEquals(M12, other.M12, tolerance) &&
                zMath.ApproxEquals(M13, other.M13, tolerance) &&

                zMath.ApproxEquals(M20, other.M20, tolerance) &&
                zMath.ApproxEquals(M21, other.M21, tolerance) &&
                zMath.ApproxEquals(M22, other.M22, tolerance) &&
                zMath.ApproxEquals(M23, other.M23, tolerance) &&

                zMath.ApproxEquals(M30, other.M30, tolerance) &&
                zMath.ApproxEquals(M31, other.M31, tolerance) &&
                zMath.ApproxEquals(M32, other.M32, tolerance) &&
                zMath.ApproxEquals(M33, other.M33, tolerance);
        }
