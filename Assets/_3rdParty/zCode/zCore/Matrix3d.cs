...
namespace zCode.zCore
{
    ...
    public struct Matrix3d
    {
        ...
        */
        ...
        /// <returns></returns>
        public static Matrix3d CreateJacobian(Func<Vec3d, Vec3d> function, Vec3d vector, double epsilon = zMath.ZeroTolerance)
        {
        ...
        /// <returns></returns>
        public bool ApproxEquals(ref Matrix3d other, double tolerance = zMath.ZeroTolerance)
        {
            return
