    ...
    public struct Matrix2d
    {
        ...
        public static class Decompose
        {
            ...
            public static bool Eigen(Matrix2d matrix, out Matrix2d vectors, out Vec2d values)
            {
                ...
                if (zMath.SolveQuadratic(1.0, -matrix.Trace, matrix.Determinant, out var r0, out var r1))
                {
                    values.X = r0;
                    values.Y = r1;
        ...
        */
        ...
        /// <returns></returns>
        public static Matrix2d CreateJacobian(Func<Vec2d, Vec2d> function, Vec2d vector, double epsilon = zMath.ZeroTolerance)
        {
            (var x, var y) = vector;
        ...
        /// <returns></returns>
        public bool ApproxEquals(Matrix2d other, double tolerance = zMath.ZeroTolerance)
        {
            return
