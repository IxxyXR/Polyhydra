...
namespace zCode.zCore
{
    ...
    public static class GeometryUtil
    {
        ...
        /// <returns></returns>
        public static Vec2d GetGradient(Func<Vec2d, double> function, Vec2d vector, double epsilon = zMath.ZeroTolerance)
        {
            (var x, var y) = vector;
        ...
        /// <param name="epsilon"></param>
        /// <returns></returns>
        public static Vec3d GetGradient(Func<Vec3d, double> function, Vec3d vector, double epsilon = zMath.ZeroTolerance)
        {
        ...
        /// <param name="epsilon"></param>
        public static void GetGradient(Func<double[], double> function, double[] vector, double[] result, double epsilon = zMath.ZeroTolerance)
        {
