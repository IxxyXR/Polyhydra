...
namespace zCode.zCore
{
    ...
    public static partial class IEnumerableExtension
    {
        ...
        /// <returns></returns>
        public static IEnumerable<Vec2d> RemoveCoincident(this IEnumerable<Vec2d> points, double tolerance = zMath.ZeroTolerance)
        {
        ...
        /// <param name="indexMap"></param>
        /// <returns></returns>
        public static List<Vec2d> RemoveCoincident(this IEnumerable<Vec2d> points, out List<int> indexMap, double tolerance = zMath.ZeroTolerance)
        {
        ...
        /// <param name="indexMap"></param>
        /// <returns></returns>
        public static IEnumerable<Vec3d> RemoveCoincident(this IEnumerable<Vec3d> points, double tolerance = zMath.ZeroTolerance)
        {
            return DataUtil.RemoveCoincident(points, p => p, null, tolerance);
        }
        ...
        /// <param name="indexMap"></param>
        /// <returns></returns>
        public static List<Vec3d> RemoveCoincident(this IEnumerable<Vec3d> points, out List<int> indexMap, double tolerance = zMath.ZeroTolerance)
        {
            return DataUtil.RemoveCoincident(points, p => p, out indexMap, null, tolerance);
        }
