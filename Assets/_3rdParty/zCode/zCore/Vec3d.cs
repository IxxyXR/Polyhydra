...
namespace zCode.zCore
{
    ...
    public partial struct Vec3d
    {
        ...
        /// 
        /// </summary>
        public bool IsZero(double tolerance = zMath.ZeroTolerance)
        {
        ...
        /// 
        /// </summary>
        public bool IsUnit(double tolerance = zMath.ZeroTolerance)
        {
            return zMath.ApproxEquals(SquareLength, 1.0, tolerance);
        }
        ...
        {
            double r = Length;
            return new Vec3d(r, Math.Atan(Y / X), zMath.AcosSafe(Z / r));
        }
        ...
        /// <returns></returns>
        public bool ApproxEquals(Vec3d other, double tolerance = zMath.ZeroTolerance)
        {
            return
