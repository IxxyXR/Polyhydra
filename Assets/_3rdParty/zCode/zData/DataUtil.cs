...
namespace zCode.zData
{
    ...
    public static class DataUtil
    {
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<T> RemoveCoincident<T>(IEnumerable<T> items, Func<T, Vec3d> getPosition, HashGrid3d<Vec3d> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            if (grid == null)
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static List<T> RemoveCoincident<T>(IEnumerable<T> items, Func<T, Vec3d> getPosition, out List<int> indexMap, HashGrid3d<int> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            if (grid == null)
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<int> GetFirstCoincident<T>(IEnumerable<T> items, Func<T, Vec2d> getPosition, HashGrid2d<(Vec2d, int)> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            if (grid == null)
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<int> GetFirstCoincident<T>(IEnumerable<T> items, Func<T, Vec3d> getPosition, HashGrid3d<(Vec3d, int)> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            if (grid == null)
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<int> GetFirstCoincident<T>(IEnumerable<T> itemsA, IEnumerable<T> itemsB, Func<T, Vec2d> getPosition, HashGrid2d<(Vec2d, int)> grid = null, double tolerance = zMath.ZeroTolerance)
        {
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<int> GetFirstCoincident<T, U>(IEnumerable<T> itemsA, Func<T, Vec2d> getPositionA, IEnumerable<U> itemsB, Func<U, Vec2d> getPositionB, HashGrid2d<(Vec2d, int)> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            if (grid == null)
                grid = new HashGrid2d<(Vec2d, int)>();
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<int> GetFirstCoincident<T>(IEnumerable<T> itemsA, IEnumerable<T> itemsB, Func<T, Vec3d> getPosition, HashGrid3d<(Vec3d, int)> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            return GetFirstCoincident(itemsA, getPosition, itemsB, getPosition, grid, tolerance);
        }
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<int> GetFirstCoincident<T, U>(IEnumerable<T> itemsA, Func<T, Vec3d> getPositionA, IEnumerable<U> itemsB, Func<U, Vec3d> getPositionB, HashGrid3d<(Vec3d, int)> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            if (grid == null)
                grid = new HashGrid3d<(Vec3d, int)>();
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<IEnumerable<int>> GetAllCoincident<T>(IEnumerable<T> itemsA, IEnumerable<T> itemsB, Func<T, Vec2d> getPosition, HashGrid2d<(Vec2d, int)> grid = null, double tolerance = zMath.ZeroTolerance)
        {
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<IEnumerable<int>> GetAllCoincident<T, U>(IEnumerable<T> itemsA, Func<T, Vec2d> getPositionA, IEnumerable<U> itemsB, Func<U, Vec2d> getPositionB, HashGrid2d<(Vec2d, int)> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            if (grid == null)
                grid = new HashGrid2d<(Vec2d, int)>();
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<IEnumerable<int>> GetAllCoincident<T>(IEnumerable<T> itemsA, IEnumerable<T> itemsB, Func<T, Vec3d> getPosition, HashGrid3d<(Vec3d, int)> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            return GetAllCoincident(itemsA, getPosition, itemsB, getPosition, grid, tolerance);
        }
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<IEnumerable<int>> GetAllCoincident<T, U>(IEnumerable<T> itemsA, Func<T, Vec3d> getPositionA, IEnumerable<U> itemsB, Func<U, Vec3d> getPositionB, HashGrid3d<(Vec3d, int)> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            if (grid == null)
                grid = new HashGrid3d<(Vec3d, int)>();
        ...
        /// <returns></returns>
        public static bool ConsolidatePoints(IList<Vec2d> points, double radius, double tolerance = zMath.ZeroTolerance, int maxSteps = 4)
        {
        ...
        /// <param name="maxSteps"></param>
        /// <returns></returns>
        public static bool ConsolidatePoints(IList<Vec3d> points, double radius, double tolerance = zMath.ZeroTolerance, int maxSteps = 4)
        {
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<int> GetFirstCoincident<T>(IReadOnlyList<T> itemsA, IReadOnlyList<T> itemsB, Func<T, Vec2d> getPosition, HashGrid2d<int> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            return GetFirstCoincident(itemsA, getPosition, itemsB, getPosition, grid, tolerance);
        }
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<int> GetFirstCoincident<T, U>(IReadOnlyList<T> itemsA, Func<T, Vec2d> getPositionA, IReadOnlyList<U> itemsB, Func<U, Vec2d> getPositionB, HashGrid2d<int> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            if (grid == null)
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<int> GetFirstCoincident<T>(IReadOnlyList<T> itemsA, IReadOnlyList<T> itemsB, Func<T, Vec3d> getPosition, HashGrid3d<int> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            return GetFirstCoincident(itemsA, getPosition, itemsB, getPosition, grid, tolerance);
        }
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<int> GetFirstCoincident<T, U>(IReadOnlyList<T> itemsA, Func<T, Vec3d> getPositionA, IReadOnlyList<U> itemsB, Func<U, Vec3d> getPositionB, HashGrid3d<int> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            if (grid == null)
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<IEnumerable<int>> GetAllCoincident<T>(IReadOnlyList<T> itemsA, IReadOnlyList<T> itemsB, Func<T, Vec2d> getPosition, HashGrid2d<int> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            return GetAllCoincident(itemsA, getPosition, itemsB, getPosition, grid, tolerance);
        }
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<IEnumerable<int>> GetAllCoincident<T, U>(IReadOnlyList<T> itemsA, Func<T, Vec2d> getPositionA, IReadOnlyList<U> itemsB, Func<U, Vec2d> getPositionB, HashGrid2d<int> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            if(grid == null)
                grid = new HashGrid2d<int>(itemsB.Count);
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<IEnumerable<int>> GetAllCoincident<T>(IReadOnlyList<T> itemsA, IReadOnlyList<T> itemsB, Func<T, Vec3d> getPosition, HashGrid3d<int> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            return GetAllCoincident(itemsA, getPosition, itemsB, getPosition, grid, tolerance);
        }
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static IEnumerable<IEnumerable<int>> GetAllCoincident<T, U>(IReadOnlyList<T> itemsA, Func<T, Vec3d> getPositionA, IReadOnlyList<U> itemsB, Func<U, Vec3d> getPositionB, HashGrid3d<int> grid = null, double tolerance = zMath.ZeroTolerance)
        {
            if(grid == null)
                grid = new HashGrid3d<int>(itemsB.Count);
