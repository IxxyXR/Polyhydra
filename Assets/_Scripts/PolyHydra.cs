...
public class PolyHydra : MonoBehaviour
{
	...
	public ConwayPoly MakeGrid(GridEnums.GridTypes gridType, GridEnums.GridShapes gridShape)
	{
...
//				break;
		...
		if (gridShape != GridEnums.GridShapes.Plane) conway = conway.Weld(0.001f);
