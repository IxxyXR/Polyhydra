...
sealed class ApplyConwayOp : MenuAction
{
    ...
    {
        GUILayout.Label("Apply Conway Operator", EditorStyles.boldLabel);
...
//				MenuOption.CloseAll();
    ...
    public override ActionResult DoAction()
    {
        ...
        pmesh.RebuildWithPositionsAndFaces(verts, faces);
        pmesh.Refresh();
        EditorMeshUtility.Optimize(pmesh, true);
